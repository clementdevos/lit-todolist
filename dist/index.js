...
let MyElement = (_dec = customElement('my-element'), _dec2 = property(), _dec(_class = (_class2 = (_temp = class MyElement extends LitElement {
  constructor(...args) {
    super(...args);
...
}, _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "foo", [_dec2], {
  configurable: true,
  enumerable: true,
  writable: true,
